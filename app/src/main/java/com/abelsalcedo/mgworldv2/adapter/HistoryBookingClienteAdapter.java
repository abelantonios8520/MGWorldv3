...
public class HistoryBookingClienteAdapter extends FirebaseRecyclerAdapter<HistoryBooking, HistoryBookingClienteAdapter.ViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull final ViewHolder holder, int position, @NonNull HistoryBooking historyBooking) {
        ...
        holder.textViewCalification.setText(String.valueOf(historyBooking.getCalificationCliente()));
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mContext, HistoryBookingDetailClienteActivity.class);
