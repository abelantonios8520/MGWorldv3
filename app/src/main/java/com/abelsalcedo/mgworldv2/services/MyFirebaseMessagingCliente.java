package com.abelsalcedo.mgworldv2.services;
...
import com.abelsalcedo.mgworldv2.activities.colaborador.NotificationBookingActivity;
import com.abelsalcedo.mgworldv2.channel.NotificationHelper;
import com.abelsalcedo.mgworldv2.receivers.AcceptReceiver;
import com.abelsalcedo.mgworldv2.receivers.CancelReceiver;
import com.google.firebase.messaging.FirebaseMessagingService;
import com.google.firebase.messaging.RemoteMessage;

import java.util.Map;

public class MyFirebaseMessagingCliente extends FirebaseMessagingService {
        ...
        if (title != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                if (title.contains("SOLICITUD DE SERVICIO")) {
                    ...
                    showNotificationApiOreoActions(title, body, idCliente);
                ...
                if (title.contains("SOLICITUD DE SERVICIO")) {
                    ...
                    String min = data.get("min");
                    String distance = data.get("distance");
                    showNotificationActions(title, body, idCliente);
                    showNotificationActivity(idCliente, origin, destination, min, distance);
                }
                else if (title.contains("VIAJE CANCELADO")) {
                    NotificationManager manager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
    ...
    private void showNotificationActions(String title, String body, String idCliente) {
        // ACEPTAR
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    private void showNotificationApiOreoActions(String title, String body, String idCliente) {
