package com.abelsalcedo.mgworldv2.channel;
...
public class NotificationHelper  extends ContextWrapper  {
    private static final String CHANNEL_ID = "com.abelsalcedo.mgworldv2";
    private static final String CHANNEL_NAME = "MGWorld";
